...
* `轮胎胎面宽度和断面宽度示意图`
```
轮胎断面宽度：轮胎断面宽度是指轮胎按规定充气后，两外侧之间的最大距离

轮胎胎面宽度：是指轮胎跟地面接触的部位宽度
```
![宽度](./images/ltkd.jpg)
* `轮胎术语以及技术参考表`
![实际参数图示](./images/lt_arg_2.jpg)
```
轮胎断面高度:就是指轮胎的高度或者厚度，是轮胎外表面到轮辋支撑面之间的距离，即轮胎的半径减去轮辋的半径。
扁平比: 扁平比=断面高度/断面宽度×100%。高扁平比的轮胎由于胎壁长，缓冲能力强，相对来说舒适性较高，但对路面的感觉较差，转弯时的侧向抵抗力弱；反之，低扁平比、大内径的轮胎，因胎壁较短，胎面宽阔，因而接地面积大，轮胎可承受的压力亦大，对路面反应非常灵敏，转弯时的侧向抵抗能力强，车辆的操控性强。
轮辋直径:见图示
轮胎辐射层结构：R表示子午胎、D和——表示斜交胎、TG表示工程牵引车和平地机轮胎（非公路用）、XL表示质地局部加强胎、NHS非公路使用轮胎
胎体帘线材料：以汉语拼音表示。如M-棉帘布、R-人造丝帘布、N-尼龙帘布、G-钢丝帘布、ZG-钢丝子午线帘布轮胎。不同结构的特性是不一样的。
载重系数：载重系数代表着轮胎最大能承受的重量，数值越大，代表高轮胎的承压能力越强。
速度级别：表示轮胎能承受的最高速度。L-120km/h、M-130km/h、N-140km/h、P-150km/h、Q-160km/h、R-170km/h、S-180km/h、T-190km/h、U-200km/h、H-210km/h、V-240km/h、W-270km/h、Y-300km/h
其他参数还有轮胎品牌名称、轮胎花纹等参数。
```
* `轮胎生产日期`
![轮胎生产日期](./images/lt_arg_1.jpg)
```
如图所示：3513
其中35表示生产周数，
13表示生产年份
在更换或者购买的轮胎的时候就要注意购买接近当前日期更好了，因为轮胎为橡胶制作，在未装配充气情况下，会存在一定的变形现象。
```
* `轮胎花纹种类`
```
1、纵向花纹：纵向花纹与轮胎轮动方向一致，拥有不错的指向性和排水性能，高速行驶时噪音相对较少。纵向花纹轮胎虽然可以提供良好的运动操控性，但是由于只有纵向花纹，所以抓地能力并不理想

2、横向花纹：横向花纹能够提供不错的抓地力，而且在制动能力方面表现也很出色。这种花纹的轮胎在专业领域用途比较广，比如一些农业机械、工程机械和大型牵引车等都可能使用到横向花纹轮胎。这种花纹轮胎的缺点是胎噪大，易磨损，耗油高，高速性能差。
3、混合花纹轮胎：混合花纹轮胎就是把纵向、横向花纹混合在一起，纵向花纹主要起到快速排水的作用，横向花纹拥有较高的抓地能力。目前这种混合花纹轮胎被广泛运用于轿车，客车，货车等绝大数车辆上，是一种均衡的选择。
4、不对称花纹轮胎：轮胎的左右两边拥有不同的花纹结构。由于左右花纹结构不同，可以让轮胎拥有不同的优势属性，比如一半花纹可以侧重排水能力，另一半花纹可以侧重抓地能力等。由于这种轮胎内外花纹不同，所以在安装的时候是分内外的，一定要注意。
```
[更多资料](https://jingyan.baidu.com/article/2fb0ba40f415f900f2ec5f0a.html)
## 购买注意事项
* `如何查看汽车出厂日期`
```
1、查看引擎舱铭牌
2、在副驾驶或主驾驶车门打开时，通常可以在车角对应的位置，看到一个黑色的铭牌
3、在前挡风玻璃上会有vin号，俗称车架号
```
[更多资料](http://www.diandong.com/zixun/57686.html)